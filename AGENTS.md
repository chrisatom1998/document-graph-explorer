...
- Tests run under Vitest (Node by default, jsdom where a file opts in) and cover pipeline/graph modules plus UI/jsdom helpers, coordinator ingest with mocked workers, and aggregator message contracts. There is no browser/3D e2e suite.

...
interface EdgeColorCtx {
  ...
  focusId: string | null;
  flat: boolean;
  /** 2D balanced detail: non-backbone edges are dimmed unless emphasized. */
  flatDetailBalanced: boolean;
  fade: number;
...
export default function Edges() {
  ...
  const fillEdgeColor = (
    ...
    const { emphasis, focusId, flat, flatDetailBalanced, fade, clusterOf, pathHops } = ctx;
  ...
  const recomputeColors = (): void => {
    ...
    const ctx: EdgeColorCtx = {
      ...
      flat,
      flatDetailBalanced: ui.flatEdgeDetail === 'balanced',
